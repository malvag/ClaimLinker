		...
		for (CLAnnotation clAnnotation : clAnnotations) {
			...
			for (Object claim : new ArrayList<>((Collection<?>)objectMap.get("linkedClaims"))) {
				...
				JsonObject linkedClaim_obj = Json.createObjectBuilder()
						.add("claimReview_claimReviewed", (String) linkedClaim.getObjectMap().get("claimReview_claimReviewed"))
						.add("_score", (Double) linkedClaim.getObjectMap().get("_score"))
						.add("extra_title", (String) linkedClaim.getObjectMap().get("extra_title"))
						.add("rating_alternateName", (String) linkedClaim.getObjectMap().get("rating_alternateName"))
						.add("creativeWork_author_name", (String) linkedClaim.getObjectMap().get("creativeWork_author_name"))
						.add("claimReview_url", (String) linkedClaim.getObjectMap().get("claimReview_url"))
						.build();
